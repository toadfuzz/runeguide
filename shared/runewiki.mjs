...
export function slugifyQuestTitle(input) {
  return input
    .trim()
    .toLowerCase()
    .replace(/[^a-z0-9]+/g, '-')
...
export function guessStepKind(text) {
...
export async function fetchRuneWikiGuide(source) {
...
export function parseRuneWikiHtml(html, sourceUrl) {
